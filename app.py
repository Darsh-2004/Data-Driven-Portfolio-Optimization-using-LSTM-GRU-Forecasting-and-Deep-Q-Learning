...
# Define the LSTMModel class (if not imported from another module)
...
# Load the model
loaded_model = joblib.load('Models/lstm_gru_model.pth')
...
def predict_stock_price(ticker):
    ...
    try:
        ...
        return jsonify({
            ...
            "prediction_type": "Advance Technicalcv Analysis",
